...
function PostItem({post}) {
  ...
  return (
    <Link to={`/${post._id}`} style={{textDecoration: 'none', color: 'inherit', border: '2px solid black', padding: '15px', backgroundColor: 'rgb(134, 134, 134)'}}><div className={styles['container']}>
