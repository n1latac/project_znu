  ...
  return (
    <section className={styles['html-main']}>
        ...
        <ul className={styles['whatIsHtml-list']}>
            <li>1. тег, що відкриває: Він складається з назви (позначення) елемента (у нашому випадку, p), поміщеного всередині кутових дужок. Цей тег слугує ознакою початку елемента, з цього моменту тег починає впливати на наступний після нього вміст.</li>
            <li>2. Тег, що закриває: має такий самий вигляд, як і той, що відкриває, але містить слеш перед назвою тега. Він слугує ознакою кінця елемента. Пропуски закриваючих тегів - типова помилка новачків, яка може призводити до невизначених результатів - у кращому випадку все спрацює правильно, в інших сторінка може зовсім не промалюватися або промальовуватися не так, як очікувалося.</li>
            <li>3. Вміст: Як видно, у нашому випадку вмістом є простий текст.</li>
            <li>4 Елемент: відкриваючий тег + закриваючий тег + вміст = елемент.</li>
        </ul>
        ...
        <div className={styles['whatIsHtml-example']}>Першийдругийтретій<br/><br/>
        четвертий
            <br/>
            <br/>
            п'ятий
